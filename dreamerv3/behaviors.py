...
class Greedy(nj.Module):
    ...
    def __init__(self, wm, act_space, config, grounded_state_normalizer_params=None):
        rewfn = lambda s: wm.reward_head(s).mean()[1:]
        ...
        self.ac = agent.ImagActorCritic(
            critics, {'extr': 1.0}, act_space, config, grounded_state_normalizer_params, name='ac')
...
class Explore(nj.Module):
    ...
    def __init__(self, wm, act_space, config, grounded_state_normalizer_params=None):
        ...
        self.ac = agent.ImagActorCritic(
            critics, scales, act_space, config, grounded_state_normalizer_params, name='ac')
