...
class DMC(embodied.Env):
    ...
    def __init__(self, env, repeat=1, sum_rewards_between_action_repeat=True, render=True, size=(64, 64), camera=-1):
        ...
        self._env = embodied.wrappers.ActionRepeat(self._env, repeat=repeat,
                                                   sum_intra_step_rewards=sum_rewards_between_action_repeat)
        self._render = render
        self._size = size
        self._camera = camera
