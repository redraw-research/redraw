...
def eval_only_gen_replay(agent, env, eval_replay, logger, args):
    ...
    if args.from_checkpoint:
        ...
        print("!!!NOT LOADING A CHECKPOINT, HOPEFULLY THIS IS INTENDED!!!!")
    ...
    driver(policy, episodes=num_eval_episodes)
    logger.add(metrics.result())
    logger.add(timer.stats(), prefix='timer')
    logger.write(fps=True)
    logger.write()
    eval_replay.save(wait=True)
