...
import dreamerv3.embodied.replay.chunk as chunklib
from dreamerv3 import embodied
from dreamerv3.embodied.core import Replay


class NaiveChunks(Replay):
    ...
    def _sample(self):
        ...
        seq['is_first'][0] = True
        seq['is_last'][-1] = True  # added for SimDreamer
        return seq
